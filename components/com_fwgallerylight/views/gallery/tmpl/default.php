...
?>
			...
			<div class="col-sm-4 text-center">
				<a href="<?php echo JRoute::_($back_link); ?>" class="fwg-back2gallery">
...
if ($this->list) {
?>
	<form action="<?php echo JRoute :: _('index.php?option=com_fwgallerylight&view=gallery&Itemid='.$input->getInt('Itemid').($this->obj->id?('&id='.$this->obj->id):'')); ?>" method="post">
	    <div class="row fwg-toolbar">
			<div class="col-sm-4 text-left">
<?php
if ($this->params->get('display_gallery_sorting')) {
