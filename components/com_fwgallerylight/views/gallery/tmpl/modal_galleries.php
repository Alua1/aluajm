...
?>
<form action="<?php echo JRoute::_('index.php?option=com_fwgallerylight&view=gallery&layout=modal&sublayout=galleries&tmpl=component&function='.$this->function); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
    <div class="row-fluid">
