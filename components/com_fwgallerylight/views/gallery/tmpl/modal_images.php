...
?>
<form action="<?php echo JRoute::_('index.php?option=com_fwgallerylight&view=gallery&layout=modal&sublayout=images&tmpl=component&function=' . $this->function . '&' . JSession::getFormToken() . '=1'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
    <div class="row-fluid">
                ...
                <td>
                    <div class="row center">
                        <a href="javascript:" onclick="if (window.parent) window.parent.<?php echo $this->escape($this->function); ?>('<?php echo $file->id; ?>');">
							<?php echo JRoute::_('index.php?option=com_fwgallerylight&view=image&layout=image&format=raw&id='.$file->id.'&w=80&h=60'); ?>
                        </a>
                    </div>
                </td>
